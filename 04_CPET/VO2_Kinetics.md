...
- Goulding 2021 進一步強調，在 steady-state 條件下，O2 deficit 可近似理解為 `ΔV̇O2 × τV̇O2`。
...
- [[../09_來源摘要/Zhang_1991_fitness_VO2_VCO2_step_kinetics]] 顯示：
...
- [[../09_來源摘要/Geor_2000_horse_warmup_VO2_VCO2_kinetics]] 則提供 comparative physiology 補充：
...
- 但 recovery / off-kinetics 的應用仍要保守：
  - Wooten 2021 這類 pilot study 提示，estimated excess VCO2 可能和 recovery / performance fatigability 有關
  - 不過這屬 indirect、hypothesis-generating evidence，還不是 routine CPET doctrine
...
- 兒童 heavy-intensity exercise 並不代表沒有 slow-component-like behavior；單篇 original article 顯示其 kinetics 仍可呈現 delayed secondary rise。
- 但 pediatric kinetics 的 secondary component 參數穩定性較差，實務上通常仍以較穩健的 phase-2 window 估計 primary component。
...
- [[09_來源摘要/Zacca_2019_VO2FITTING_software]]
- [[09_來源摘要/Wooten_2021_excess_VCO2_recovery_fatigability]]
- [[09_來源摘要/Francescato_Cettolo_2021_VO2_fitting_window]]
- [[09_來源摘要/Zhang_1991_fitness_VO2_VCO2_step_kinetics]]
- [[09_來源摘要/Geor_2000_horse_warmup_VO2_VCO2_kinetics]]
