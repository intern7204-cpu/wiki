...
Early intervention (EI) 是 birth to 2 years 的早期發展支持系統，核心不是把 child 帶去上課，而是把 **assessment、IFSP、coaching 與日常情境中的學習機會** 串起來。

## 核心機制

### 誰是 EI 的典型對象

- 顯著 developmental delay child
- diagnosed condition with high probability of delay
- 某些系統也會納入 at-risk child

### 服務核心

### IFSP

- 以 family priorities、daily routine、functional goal 為中心。

### natural environment

- home、daycare、park、community activity 等 child 真正生活的地方。

### primary coaching

- provider 和 caregiver 協作，而不是 provider 單向示範、家長被動接受。

### practical referral thinking

- 不要等 definitive diagnosis 才轉介。
- referral 時應盡量說清楚：
  - concern domain
  - current function
  - red flag
...
- Part C EI 是一套 statewide system，包含 Child Find、multidisciplinary evaluation、IFSP、natural environment 與 family support。
- program eligibility 受州別或制度差異影響很大，不能拿來反推 child 的臨床重要性。

### 結論

- EI 的本質是 **family-centered developmental service system**，不是單純 treatment slot。
...
- Early Intervention 總論 和最相近、最常被混用的概念差在哪？
...
- 若要把 Early Intervention 總論 用在 bedside 或運動處方，先確認它回答的是哪一個機制或強度邊界，再決定能否改變評估與處置。
